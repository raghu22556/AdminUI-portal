...
const LoginPage = () => {
  ...
  <div className="text-start m-4">
    <Typography variant="h5" color="white">MaidanCube</Typography>
    <Typography variant="h1" color="white" className="mt-4">Your gateway</Typography>
    <Typography variant="h1" color="white">to progress.</Typography>
  </div>
</div>
</div>
        </div>
