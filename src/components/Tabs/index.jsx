...
import navPillsStyle from './styles.jsx';
...
class NavPills extends React.Component {
  ...
  render() {
    const { classes, tabs, direction, color, horizontal, alignCenter, noRadius } = this.props;
      ...
      >
        {tabs.map((prop, key) => {
          ...
          const pillsClasses = classNames({
            ...
            [classes.pillsWithOutRadius]: noRadius !== undefined,
          });
          return (
            <Tab
              disableRipple={disableRippleEffect}
